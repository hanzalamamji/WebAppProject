...
{
    public class AlternateElectricityResultController : Controller
    {
        // GET: AlternateElectricityResult
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //string username = 64.ToString();

            var data = db.Database.SqlQuery<GetWattsRecordsForAlternateElectricityAppliancePages_Result>("GetWattsRecordsForAlternateElectricityAppliancePages @username", new SqlParameter("@username", username)).ToList();
