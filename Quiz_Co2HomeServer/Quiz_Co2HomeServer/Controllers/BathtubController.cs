    ...
    public class BathtubController : Controller
    {
        ...
        public async Task<ActionResult> Question2()
        {
            ...
            try
            {
                ...
                {
                    Prompt = "show 10 asian names of model of Electric Bathtub along there companies",
        ...
        public async Task<List<string>> GetRefrigeratorNamesAsync()
        {
            ...
            var completionRequest = new CompletionRequest
            {
                Prompt = "Top 10 Electric Bathtub companies",
                Model = Model.DavinciText,
                MaxTokens = 100,
            };
        ...
        public async Task<List<string>> GetRefrigeratorNamesAsyncn()
        {
            ...
            var completionRequest = new CompletionRequest
            {
                Prompt = "Generate 10 Model Of" + make1 + "Electric Bathtubs ",
                Model = Model.DavinciText,
                MaxTokens = 100,
            };
        ...
        public async Task<List<string>> GetRefrigeratorNamesAsync2()
        {
            ...
            var completionRequest = new CompletionRequest
            {
                Prompt = "Generate 10 Model Of" + make2 + "Electric Bathtubs ",
                Model = Model.DavinciText,
                MaxTokens = 100,
            };
        ...
        public async Task<List<string>> GetRefrigeratorNamesAsync3()
        {
            ...
            var completionRequest = new CompletionRequest
            {
                Prompt = "Generate 10 Model Of" + make3 + "Electric Bathtubs ",
                Model = Model.DavinciText,
                MaxTokens = 100,
            };
