...
namespace Quiz_Co2HomeServer.Controllers
{
    public class DryerController : Controller
    {
                ...
                var hardcodedTips1 = new List<string>
        {
            ...
            "Dry similar types of fabrics together to optimize drying times."
        };

                var hardcodedTips2 = new List<string>
        {
            "Avoid overloading the dryer to ensure proper airflow.",
            "Use a lower heat setting when possible to save energy.",
            "Consider air-drying clothes whenever possible to reduce dryer use."
        };

                var hardcodedTips3 = new List<string>
        {
            "Make sure the dryer vent is clean and unobstructed to improve efficiency.",
            "Upgrade to an Energy Star certified dryer to reduce energy consumption.",
        ...
        public ActionResult UpdateTips(string AffilaiteLink, string ImageAddress, tbl_Refrigilator model)
        {
            ...
            return RedirectToAction("Index", "KitchenResult");
        }
