...
{
    public class HeatingAndCoolingResultController : Controller
    {
        // GET: HeatingAndCoolingResult
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //string username = 6.ToString();

            var data = db.Database.SqlQuery<GetWattsRecordsForHeatingAndCoolingAppliancesPage_Result>("GetWattsRecordsForHeatingAndCoolingAppliancesPage @username", new SqlParameter("@username", username)).ToList();
