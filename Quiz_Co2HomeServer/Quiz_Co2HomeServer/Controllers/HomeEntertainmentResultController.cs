...
{
    public class HomeEntertainmentResultController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //string username = 14.ToString();

            var data = db.Database.SqlQuery<GetWattsRecordsForHomeEntertainmentAppliance_Result>("GetWattsRecordsForHomeEntertainmentAppliance @username", new SqlParameter("@username", username)).ToList();
