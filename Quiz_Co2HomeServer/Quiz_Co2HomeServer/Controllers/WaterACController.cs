    ...
    public class WaterACController : Controller
    {
        ...
        public async Task<ActionResult> Question2()
        {
            ...
            try
            {
                ...
                {
                    Prompt = "show 10 asian names of model of Air conditioners along there companies",
        ...
        public async Task<List<string>> GetRefrigeratorNamesAsync()
        {
            ...
            var completionRequest = new CompletionRequest
            {
                Prompt = "Top 10 Air conditioners companies",
                Model = Model.DavinciText,
                MaxTokens = 100,
            };
        ...
        public async Task<List<string>> GetRefrigeratorNamesAsyncn()
        {
            ...
            var completionRequest = new CompletionRequest
            {
                Prompt = "Generate 10 Model Of" + make1 + "Air conditioners ",
                Model = Model.DavinciText,
                MaxTokens = 100,
            };
        ...
        public async Task<List<string>> GetRefrigeratorNamesAsync2()
        {
            ...
            var completionRequest = new CompletionRequest
            {
                Prompt = "Generate 10 Model Of" + make2 + "Air conditioners ",
                Model = Model.DavinciText,
                MaxTokens = 100,
            };
        ...
        public async Task<List<string>> GetRefrigeratorNamesAsync3()
        {
            ...
            var completionRequest = new CompletionRequest
            {
                Prompt = "Generate 10 Model Of" + make3 + "Air conditioners ",
                Model = Model.DavinciText,
                MaxTokens = 100,
            };
