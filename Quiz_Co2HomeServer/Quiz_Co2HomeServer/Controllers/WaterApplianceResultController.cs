...
{
    public class WaterApplianceResultController : Controller
    {
        // GET: WaterApplianceResult
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //string username = 22.ToString();

            var data = db.Database.SqlQuery<GetWattsRecordsForWaterAppliance_Result>("GetWattsRecordsForWaterAppliance @username", new SqlParameter("@username", username)).ToList();
